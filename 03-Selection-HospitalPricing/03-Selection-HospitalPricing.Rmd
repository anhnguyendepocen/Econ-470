...
\begin{center}
\includegraphics[page=107,width=0.5\linewidth]{pics/HCRISForms.pdf}
\end{center}
...
--
<br>
Forming this dataset will be up to you this time!
...
hcris.data <- read_rds("C:/Users/immccar/CloudStation/Professional/Research Projects/_Git/HCRIS/data/HCRIS_Data.rds")
```
...
love.plot(bal.tab(lp.covs,treat=lp.vars$penalty), shapes=16, size=1.5) + 
...
```{r nn-matching1, eval=FALSE, warning=FALSE}
match.dat <- matchit(penalty ~ beds + mcaid_discharges + ip_charges + mcare_discharges + tot_mcare_payment, data=lp.vars, method="nearest", ratio=1, distance="mahalanobis")

v=data.frame(new=c("Beds","Medicaid Discharges", "Inaptient Charges","Medicare Discharges", "Medicare Payments"))
love.plot(match.dat, threshold=0.1, 
          var.names=v,
...
# Next steps
- show love plots
- show baseline average difference
