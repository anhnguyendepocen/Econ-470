...
---
# Interpretation
These estimates suggest a `r round(star25.3$coef[3],2)*100`% increase in market shares among 2.5-star plans versus an "identical" 2-star plan, compared to an OLS estimate of `r round(star25.1$coef[3],2)*100`% increase.
