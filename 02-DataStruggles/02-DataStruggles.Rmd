...
*Note.* Arranging on a string sorts alphabetically
...
- Sse "first:last" for consecutive columns
...
- Look out for `plyr` package. Do not use `plyr` and `dplyr` together. Just don't do.
