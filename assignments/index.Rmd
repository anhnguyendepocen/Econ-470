...
#github-repo: imccart/Econ-470/assignments
---
...
This assignment is just about data management. The goal is to give you a chance to practice wrangling and tidying data. We do this very early in the class because soon (**next week**) we will start doing some empirical analysis using real data. The sooner you are comfortable with the datasets, the better.
...
You can submit your answers in html format. Just upload the html file to Canvas. Please also adopt the naming convention, *'last name'-'first initial'-hwk1.html*. For example, in my case this would be *McCarthy-I-hwk1*. In addition to your answers, please be sure to include the `R` code that generated your answers. Practice writing good code and showing me only what I would need to recreate your results.
