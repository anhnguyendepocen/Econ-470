...
# Instructions
In this assignment, you'll recreate the HCRIS data and answer a few questions along the way. The first step is to make sure you've forked the [HCRIS GitHub repository](https://github.com/imccart/HCRIS) and downloaded all of the raw data sources. Once you have the data downloaded and the code running, answer the following questions:
